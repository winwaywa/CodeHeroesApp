...
def make_code_chunks(path: str, code: str, max_chars: int = 1000, overlap: int = 120) -> List[Dict[str, Any]]:
    """
...
def index_codebase_in_chroma(collection, batch_inputs: List[Dict[str, Any]]):
    ...
    for item in batch_inputs:
        ...
        code = item["code"]
        # Cắt ra từng chunk trong mỗi file
...
def retrieve_related_code(collection, query_text: str, exclude_path: str, k: int = 3) -> List[Dict[str, Any]]:
    """
